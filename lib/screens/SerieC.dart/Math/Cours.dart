  ...
  void _listpdf() {
    var list = <ListPdf>[
      ListPdf(
        ...
        chemin:
            'assets/pdf/serie C/Anglais/cours/134798-apprenez-a-programmer-en-vb-net.pdf',
        anAcad: '2015-2016',
      ),
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie C/Anglais/cours/145147-comment-faire-une-page-ayant-la-meme-hauteur-que-le-navigateur.pdf',
        anAcad: '2009-2010',
      ),
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie C/Anglais/cours/0023-formation-securite-informatique-pirate-pc.pdf',
        anAcad: '2010-2011',
      ),
      ListPdf(
        titre: 'Collège Vogt',
        chemin:
            'assets/pdf/serie C/Anglais/cours/147180-programmez-en-oriente-objet-en-php.pdf',
        anAcad: '2013-2014',
      ),
      ListPdf(
        titre: 'Collège Vogt',
