  ...
  void _listpdf() {
    var list = <ListPdf>[
      ListPdf(
        ...
        chemin:
            'assets/pdf/serie A/Chimie/tp/34771-creez-votre-propre-package.pdf',
        anAcad: '2017-2018',
      ),
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie A/Chimie//tp/35582-aidez-la-science-avec-folding-home.pdf',
        anAcad: '2018-2019',
      ),
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie A/Chimie/tp/35692-creer-un-menu-circulaire.pdf',
        anAcad: '2015-2016',
      ),
      ListPdf(
        titre: 'Collège Adventiste Billingue Boma de Bertoua',
        chemin:
            'assets/pdf/serie A/Chimie/tp/36048-compteur-de-telechargements.pdf',
        anAcad: '2012-2013',
      ),
      ListPdf(
        titre: 'Collège Vogt',
