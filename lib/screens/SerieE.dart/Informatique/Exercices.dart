  ...
  void _listpdf() {
    var list = <ListPdf>[
      ListPdf(
        ...
        chemin:
            'assets/pdf/serie E/Anglais/exercices/184477-la-reconnaissance-vocale-dans-son-application(1).pdf',
      ...
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie E/Anglais/exercices/186811-tout-sur-l-opensim.pdf',
        evaluation: 'Evaluation 1',
        anAcad: '2018-2019',
      ),
      ListPdf(
        titre: 'Lycée Leclers',
        chemin:
            'assets/pdf/serie E/Anglais/exercices/193225-decouverte-de-la-programmation-par-contraintes.pdf',
        evaluation: 'Evaluation 1',
        anAcad: '2015-2016',
      ),
      ListPdf(
        ...
        chemin:
            'assets/pdf/serie E/Anglais/exercices/195423-un-compte-a-rebours-en-php.pdf',
      ...
      ListPdf(
        titre: 'Collège Vogt',
        chemin:
            'assets/pdf/serie E/Anglais/exercices/200557-programmez-en-objective-c.pdf',
        evaluation: 'Evaluation 1',
        anAcad: '2011-2012',
      ),
      ListPdf(
        titre: 'Collège Vogt',
        chemin:
            'assets/pdf/serie E/Anglais/exercices/184477-la-reconnaissance-vocale-dans-son-application.pdf',
